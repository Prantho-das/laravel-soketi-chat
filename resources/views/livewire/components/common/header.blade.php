        ...
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            @else<a href="/dashboard">
                    ...
                    inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">
                        <img src="{{ auth()->user()->avatar }}" alt="" class="rounded-full h-10 w-10 mr-2">
                        Dashboard
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2" class="w-4 h-4 ml-1" viewBox="0 0 24 24">
                            <path d="M5 12h14M12 5l7 7-7 7"></path>
                ...
                <div  wire:click="logout"
                    class="
            cursor-pointer
            inline-flex items-center bg-gray-100 border-0 p-3 ml-2 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">
