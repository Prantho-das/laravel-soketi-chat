    ...
    <div class="bg-white relative lg:py-20">
      ...
      xl:px-5 lg:flex-row">
            <div class="flex flex-col items-center w-full pt-5 pr-10 pb-20 pl-10 lg:pt-20 lg:flex-row">
                ...
                <div class="w-full mt-2 mr-0 mb-0 ml-0 relative z-10 max-w-2xl lg:mt-0 lg:w-5/12">
                    @if ($showRegister)
                        <form wire:submit.prevent="register">
                            <div
                                class="flex flex-col items-start justify-start pt-10 pr-10 pb-10 pl-10 bg-white shadow-2xl rounded-xl
            relative z-10">
                                <p class="w-full text-4xl font-medium text-center leading-snug font-serif">Sign up for
                                    an
                                    account</p>
                  ...
                  absolute">
                                            Name</p>
                                        <input wire:model="name" placeholder="John" type="text"
                  ...
                  border-gray-300 rounded-md" />
                                    ...
                                    <div class="relative">
                                        <p
                                            ...
                                            Email</p>
                                        <input wire:model="email" placeholder="123@ex.com" type="email"
                                            class="border placeholder-gray-400 focus:outline-none
                  focus:border-black w-full pt-4 pr-4 pb-4 pl-4 mt-2 mr-0 mb-0 ml-0 text-base block bg-white
                  border-gray-300 rounded-md" />
                                        @error('email')
                  ...
                  rounded-lg transition duration-200 hover:bg-indigo-600 ease">Submit</button>
                                        <h2 class="cursor-pointer" wire:click='$set("showRegister",false)'>Sign In Now
                                        </h2>
                    ...
                    @else<form wire:submit.prevent="login">
                            <div
                                class="flex flex-col items-start justify-start pt-10 pr-10 pb-10 pl-10 bg-white shadow-2xl rounded-xl
            relative z-10">
                                <p class="w-full text-4xl font-medium text-center leading-snug font-serif">Sign In for
                                    an
                                    account</p>
                                <div class="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">
                  ...
                  border-gray-300 rounded-md" />
                                    ...
                                    <div class="relative">
                                        <button type="submit"
                                            class="w-full inline-block pt-4 pr-5 pb-4 pl-5 text-xl font-medium text-center text-white bg-indigo-500
                  rounded-lg transition duration-200 hover:bg-indigo-600 ease">Submit</button>
                                        <h2 class="cursor-pointer" wire:click='$set("showRegister",true)'>Sign Up First
                                        </h2>
                                    </div>
                                </div>
                            </div>
